...
disruption = read_csv("~Path_to/PTM_Disrupting_Mutations.csv")

# EDIT HERE: Insert absolute path to files, and it selects the columns needed
frequent_mutations = read_tsv("~Path_to/TCGA_Frequent_Mutations.tsv") %>% 
...
ids = read_excel("~Path_to/idmap.xlsx") %>%
  rename(gene = symbol) %>%
...
```{r}
write.csv(FINAL, "/Path//Mutation_Freuency_Count.csv") # EDIT HERE: define the path you want to write out the data for.
```
